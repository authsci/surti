<template>
  <div class="h-screen overflow-hidden boddIndexZ">
    <div id="main" class="absolute w-full -mt-12 font-mono">
      <div
        class="flex flex-col items-center content-center justify-center mb-5 mr-2"
      >
        <div class="w-8/12 mt-20">
          <h1 class="mt-5 mb-10 text-xl font-bold sm:text-3xl">Publications</h1>
          ...
          <div class="flex flex-wrap">
            ...
            >
              <img
                :src="`/Content/AUB/publications/${book.cover}`"
                class="object-cover"
          ...
          <div class="flex">
            ...
            >
              <img
                :src="`/Content/AUB/publications/${editedBook.cover}`"
                class="object-cover"
                style="-webkit-filter: grayscale(100%); filter: grayscale(100%)"
              />
              <p class="font-mono text-lg font-bold text-black">
