        ...
        <div class="w-8/12 mt-10">
          ...
          >
            <div
              ...
              :key="event.slug"
              class="w-8/12 mb-10 mr-5 sm:w-3/12"
            >
              <nuxt-link :to="event.path">
                <div class="people-fuabc">
                  <img
                    :data-src="`/Content/FUABC/events/colloquium/${event.thumbnail}`"
                    class="object-cover"
                    style="
...
export default {
  async asyncData({ $content, params }) {
    const events = await $content('FUABC/events/colloquium')
      .sortBy('slug')
      .fetch()
