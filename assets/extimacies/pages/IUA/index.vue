<template>
  <div style="overflow: hidden" class="max-h-screen boddIndexA">
    <div
      style="height: 90%"
    ...
    >
      ...
      >
        <div class="w-10/12 mt-10 ml-16 sm:w-8/12">
          <h1 class="mt-5 mb-5 text-xl font-bold sm:text-3xl">
            The Ibero-American
            <br />University
          </h1>
          ...
          >
            <span id="peoplea" class="ml-2 font-semibold">People</span>
          </div>

          <div
            id="peoplesection"
            :class="people ? 'block' : 'hidden'"
            class="p-2 mt-2"
          >
            <transition name="slide">
              ...
              >
                ...
                >
                  <div class="w-8/12 p-3 sm:w-4/12">
                    <div
                      @click="iuap1Acitve = !iuap1Acitve"
                      class="cursor-pointer people-iua"
                    >
                      <img
                        :data-src="`/Content/IUA/people/${iuap1.photo}`"
                        class="object-covr"
                        style="
                    ...
                    <div :class="iuap1Acitve ? 'block' : 'hidden'">
                      <transition
                        name="expand"
                        @enter="enter"
                  ...
                  <div class="w-8/12 p-3 sm:w-4/12">
                    <div @click="iuap2Acitve = !iuap2Acitve">
                      <div class="cursor-pointer people-iua">
                        <img
                          :data-src="`/Content/IUA/people/${iuap2.photo}`"
                          class="object-covr"
                          style="
                            -webkit-filter: grayscale(100%);
                            filter: grayscale(100%);
                    ...
                    <div :class="iuap2Acitve ? 'block' : 'hidden'">
                      <transition
                        name="expand"
                        @enter="enter"
                        @after-enter="afterEnter"
                  ...
                  <div class="w-8/12 p-3 sm:w-4/12">
                    <div @click="iuap3Acitve = !iuap3Acitve">
                      <div class="cursor-pointer people-iua">
                        <img
                          :data-src="`/Content/IUA/people/${iuap3.photo}`"
                          class="object-covr"
                          style="
                            -webkit-filter: grayscale(100%);
                            filter: grayscale(100%);
                    ...
                    <div :class="iuap3Acitve ? 'block' : 'hidden'">
                      <transition
                        name="expand"
                        @enter="enter"
                        @after-enter="afterEnter"
          ...
          <div
            ...
            class="pr-5 border-b border-black cursor-pointer hover:bg-black hover:text-white hover:font-bold"
          >
            <nuxt-link to="/IUA/publications" class="ml-2 font-semibold"
          ...
          <div
            class="pr-5 border-b border-black cursor-pointer hover:bg-black hover:text-white hover:font-bold"
          >
            <nuxt-link to="/IUA/initiatives" class="ml-2 font-semibold"
            ...
            >
              <div v-show="courses">
                ...
                >
                  <nuxt-link
                    :to="aubCourse.path"
                    class="pl-16 font-mono text-base text-black border-b border-black cursor-pointer sm:text-2xl hover:bg-black hover:text-white hover:font-bold"
...
export default {
  async asyncData({ $content, params }) {
    const iuap1 = await $content('IUA/people/001').fetch()
    const iuap2 = await $content('IUA/people/002').fetch()
    const iuap3 = await $content('IUA/people/003').fetch()
    const aubCourses = await $content('IUA/courses').sortBy('slug').fetch()
    return { iuap1, iuap2, iuap3, aubCourses }
  },
...
.people-iua:hover {
  background: rgba(252, 39, 46, 0.5);
}
.people-iua:hover > img {
  z-index: -1;
