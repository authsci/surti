    ...
    <div id="main" class="absolute w-full font-mono">
      ...
      <div class="flex flex-col items-center mb-5 text-3xl text-left">
        <div class="w-8/12 mt-10">
          ...
          <div
            class="flex flex-wrap items-start content-center justify-start mt-5"
          >
            <div
            ...
            >
              <nuxt-link :to="event.path">
                <div class="people-iua">
                  <img
                    :data-src="`/Content/IUA/events/colloquium/${event.thumbnail}`"
                    class="object-cover"
                    style="
...
export default {
  async asyncData({ $content, params }) {
    const events = await $content('IUA/events/colloquium')
      .sortBy('slug')
      .fetch()
